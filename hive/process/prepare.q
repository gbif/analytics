...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20080401
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20080627
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20081010
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20081217
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20090406
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20090617
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20090925
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20091216
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20100401
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20100726
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20101117
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20110221
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20110610
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20110905
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20120118
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20120326
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20120713
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20121031   
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20121211
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20130220
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20130521
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20130709
...
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20130910

UNION ALL

SELECT '2014-05-09' AS snapshot, id, dataset_id, publisher_id, kingdom, phylum, class_rank, order_rank, family, genus, species, scientific_name, kingdom_id, phylum_id, class_id, order_id, family_id, genus_id, species_id, taxon_id, basis_of_record, latitude, longitude, country, day, month, year, publisher_country
FROM ${hiveconf:SNAPSHOT_DB}.occurrence_20140509
