...
declare -a hbase_v3_snapshots=("20150703" "20151001" "20160104" "20160405" "20160704" "20161007" "20161227" "20170412" "20170724" "20171012" "20171222" "20180409" "20180711" "20180928" "20190101" "20190406" "20190701")

echo 'Creating MySQL snapshots'
for snapshot in "${mysql_snapshots[@]}"
do
    echo "Creating MySQL snapshot $snapshot"
...
echo 'Creating HBase V1 snapshots'
for snapshot in "${hbase_v1_snapshots[@]}"
do
    echo "Creating HBase V1 snapshot $snapshot"
...
echo 'Creating HBase V2 snapshots'
for snapshot in "${hbase_v2_snapshots[@]}"
do
    echo "Creating HBase V2 snapshot $snapshot"
...
echo 'Creating HBase V3 snapshots'
for snapshot in "${hbase_v3_snapshots[@]}"
do
    echo "Creating HBase V3 snapshot $snapshot"
