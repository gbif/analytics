...
max=$(( ${#hbase_modern_snapshots[*]} - 1 ))
last_modern_snapshot=${hbase_modern_snapshots[$max]}
...
DROP TABLE IF EXISTS snapshot.raw_taxonomy;
...
old_snapshots=( ${mysql_snapshots[@]} ${hbase_interim_snapshots[@]} )
