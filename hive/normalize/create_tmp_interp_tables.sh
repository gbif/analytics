...
hive --hiveconf occjar=/tmp/occurrence-hive.jar --hiveconf epsgjar=/tmp/gt-epsg-hsql.jar --hiveconf mapcount=100 -f interp_geo.q
hive --hiveconf occjar=/tmp/occurrence-hive.jar --hiveconf mapcount=100 -f interp_taxonomy.q